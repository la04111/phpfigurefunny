                                           ...
                                           <td class="product-image">
                                              <div class="product-thumbnail">
                                                    <div class="product-thumbnail-wrapper">
                                                        <img class="product-thumbnail-image" alt="' . $itemcart['name'] . '" src="' . $itemcart['image'] . '" />
                                                    </div>
                                                    <span class="product-thumbnail-quantity" aria-hidden="true">' . $itemcart['quantity'] . '</span>
                                                </div>
                                            </td>
                                            <td class="product-description">
                                                <span class="product-description-name order-summary-emphasis">' . $itemcart['name'] . '</span>
                                            ...
                                            <td class="product-price">
                                                <span class="order-summary-emphasis">' . number_format($itemcart['quantity'] * $itemcart['price'], 0, '.', '.') . 'đ' . '</span>
                                            </td>
                                        </tr>';
                                            }
                                        }
                                    ...
                                    if (isset($_SESSION['accountuser'])) {
                                        ...
                                        <div class="field field-required   ">
                                            <div class="field-input-wrapper">
                                                ...
                                                <input autocomplete="false" placeholder="Số điện thoại" autocapitalize="off" spellcheck="false" class="field-input" size="30" maxlength="15" type="tel" id="phonenum" name="phonenum" value="' . $user['phonenum'] . '" />
                                            </div>
                                        ...
                                        <div class="field field-required   ">
                                            <div class="field-input-wrapper">
                                                <label class="field-label" for="billing_address_phone">Số điện thoại</label>
                                                <input autocomplete="false" placeholder="Số điện thoại" autocapitalize="off" spellcheck="false" class="field-input" size="30" maxlength="15" type="tel" id="phonenum" name="phonenum" value="" />
                                            </div>
